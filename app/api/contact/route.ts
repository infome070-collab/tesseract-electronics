...
export async function POST(req: Request) {
  try {
    ...
    const result = await resend.emails.send({
      ...
      subject: `📩 New RFQ | ${service} | ${company || name}`,

      html: `
      <div style="font-family:Arial,sans-serif;background:#f4f7fb;padding:30px;">

        <div style="max-width:700px;margin:auto;background:#ffffff;border-radius:12px;padding:30px;box-shadow:0 5px 15px rgba(0,0,0,.08);">
          ...
          <h3 style="color:#0284c7;">📝 Project Details</h3>
          ...
          <h3 style="color:#0284c7;">📎 Customer Uploaded File</h3>
          ...
          <p style="color:#777;font-size:13px;">
            ...
            PCB Manufacturing • PCB Assembly • Electronic Components
          </p>
